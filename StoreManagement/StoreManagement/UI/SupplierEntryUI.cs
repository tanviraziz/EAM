...
namespace StoreManagement.UI
{
    public partial class SupplierEntryUI : Form
    {
        #region Veriables
            ...
            private bool IsEdit;
            private string supplierIdToEdit;
        #endregion
        ...
        public SupplierEntryUI(string supplierID)
            : this()
        {
            IsEdit = true;
        ...
        {
            DataTable dt = null;
            dt = settingsManager.GetSupplierList("2", supplierIdToEdit);
            if(dt.Rows.Count > 0)
            {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                if(settingsManager.SupplierManagement(supplier))
                {
        ...
        private bool IsValid()
        {
            try
            {
                ...
                {
                    MessageBox.Show("Enter suppler name.");
                    nameTextBox.Focus();
                    return false;
                }
        ...
        private void SetValues()
        {
            ...
            supplier.PhoneNo = phoneNoTextBox.Text.Trim();
            supplier.Fax = faxTextBox.Text.Trim();
            supplier.Email = emailTextBox.Text.Trim();

            if (IsEdit)
            {
                supplier.SupplierID = Convert.ToInt32(supplierIdToEdit);
                supplier.Condition = "2";
            }
        }
