...
namespace StoreManagement.UI
{
    public partial class CategoryEntryUI : Form
    {
        ...
        private void CategoryEntryUI_Load(object sender, EventArgs e)
        {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                if (setupManage.StoreCategoryManagement(category))
                {
                    ClearAllFields();
                }
            }
        ...
        private void SetValues()
        {
            ...
            //category.MapicCode = categoryTextBox.Text.Trim();
            //category.Remarks = descriptionTextBox.Text.Trim();
