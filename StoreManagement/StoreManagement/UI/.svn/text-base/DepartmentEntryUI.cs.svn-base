...
namespace StoreManagement.UI
{
    public partial class DepartmentEntryUI : Form
    {
        ...
        private Company department = null;
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                if (setupManager.DepartmentManagement(department))
                {
                    ClearAllFields();
                }
            }
        ...
        {
            if (string.IsNullOrEmpty(departmentTextBox.Text.Trim()))
            {
        ...
        private void SetValues()
        {
            ...
            department.Name = departmentTextBox.Text.Trim();
            department.Remarks = remarksTextBox.Text.Trim();
