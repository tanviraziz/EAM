...
{
    public partial class PurchaseTenderQuotationActionUI : Form
    {
        #region Veriables
        ...
        public PurchaseTenderQuotationActionUI()
        {
            InitializeComponent();
            SetObjects();
        }
        ...
        private void PurchaseTenderQuotationActionUI_Load(object sender, EventArgs e)
        {
        ...
        private void RefreshAll()
        {
            switch (purchaseTenderTabControl.SelectedIndex)
            {
                ...
                case 1:
                    ...
                    fillControl.fillListView(completeListView, tenderManager.GetPurchaseTenderList("11", null), "Req No.,Req Date,Requisition For,Total Item", "100,100,150,100", true);
                    break;
            }
        }       
        ...
        private void pendingRequisitionListView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (pendingRequisitionListView.SelectedIndices.Count > 0)
                {
                    ...
                    //fill the requisition detail
                    //fillControl.fillListView(requisitionDetailListView,tenderManager.GetPurchaseTenderList("3",reqNO),"Item,Unit,Required,","300,100,100,",false);
                    //fillControl.BuildGroups(3, requisitionDetailListView, false);
        ...
        private void printButton_Click(object sender, EventArgs e)
        {
            //if (pendingRequisitionListView.SelectedIndices.Count > 0)
            //{
            //    string reqNO = pendingRequisitionListView.Items[pendingRequisitionListView.SelectedIndices[0]].Text;
            //    ReportViwer reportViewer = null;
            //    reportViewer = new ReportViwer(tenderManager.GetPurchaseRequisition("1",reqNO), new TenderRequisitionReport() );
            //    reportViewer.Show();                
            //}
            //else
            //{
