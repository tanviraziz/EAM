...
{
    public partial class PurchaseOrderPrintUI : Form
    {
        #region Veriables
        ...
        public PurchaseOrderPrintUI(string orderNo,string termsChoice):this()
        {
        ...
        private void PurchaseOrderPrintUI_Load(object sender, EventArgs e)
        {
            ShowPrintData();
