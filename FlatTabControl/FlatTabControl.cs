...
namespace FlatTabControl
{
	...
	public class FlatTabControl : System.Windows.Forms.TabControl
	{
		...
		internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
		{
			...
			{
				pt[0] = new Point(recBounds.Left + 6, recBounds.Bottom);
				pt[1] = new Point(recBounds.Left + 6, recBounds.Top + 3);
				pt[2] = new Point(recBounds.Left + 6 + 3, recBounds.Top);
            ...
            Brush br;   // declare the brush for tab back color 
            ...
            {
                br = new SolidBrush(Color.FromArgb(211, 213, 215));
            }
			//----------------------------
